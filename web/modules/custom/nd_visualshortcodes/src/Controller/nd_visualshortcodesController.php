...
class nd_visualshortcodesController extends ControllerBase implements ContainerInjectionInterface {
   ...
   * {@inheritdoc}
   */
  public function __construct(TwigEnvironment $twig, Connection $database, ShortcodeService $shortcode, RequestStack $request_stack) {
    $this->twig = $twig;
    $this->conn = $database;
...
//    $type = $_POST['shortcode'];
    $type = $this->requestStack->getCurrentRequest()->request->get('shortcode');
